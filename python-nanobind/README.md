...
- `AbcdFunction.instantaneous_volatility`, `instantaneous_variance`, `instantaneous_covariance`
- Golden checks that variance is volatility-squared and covariance is the product of vols
