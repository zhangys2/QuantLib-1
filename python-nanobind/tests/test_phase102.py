"""Phase-102 tests: VanillaSwingOption (BS FD upper/lower bounds)."""
...
def _swing_setup():
    ...
    return payoff, forward, exercise_dates, swing_exercise, process


def test_fd_bs_swing_option_bounds():
    # SwingOptionTest::testFdBSSwingOption — upper / lower bounds.
    payoff, forward, exercise_dates, swing_exercise, process = _swing_setup()

    bermudan = ql.VanillaOption(payoff, ql.BermudanExercise(exercise_dates))
...
def test_compat_phase102_aliases():
